...
async function initDb() {
  ...
  try {
    ...
    try {
      await pgPool.query(`ALTER TABLE pesilat ADD COLUMN nomor_urut INTEGER`);
    } catch(e) {
      // Ignored
    }
  } catch(e) {
...
async function getPesilats() {
  ...
  return rows.sort((a, b) => {
    ...
    if (a.nomor_urut !== undefined && b.nomor_urut !== undefined && a.nomor_urut !== null && b.nomor_urut !== null) {
        if (a.nomor_urut !== b.nomor_urut) {
...
async function insertPesilat(p: any) {
  ...
  await pgPool.query(`
    INSERT INTO pesilat (
      id, nomor_urut, nomor_partai, nama_pesilat, kontingen, nama_pesilat_biru, kontingen_biru,
  ...
  `, [
    p.id, p.nomor_urut || null, p.nomor_partai, p.nama_pesilat, p.kontingen, p.nama_pesilat_biru || "", p.kontingen_biru || "",
